...
Stage 1 (core/maker/lp_market_screen.py) found WHERE the spread-capture prize lives. But a
...
Usage:
    uv run python -m core.maker.lp_toxicity_screen
    uv run python -m core.maker.lp_toxicity_screen --series KXRT KXNCAABASEBALL --days 5
"""
