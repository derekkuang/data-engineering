...
Usage:
    from core.maker.classify import sport, market_type
    uv run python -m core.maker.classify --emit-sql    # regenerate dbt/macros/classify.sql
"""
...
def emit_sql() -> str:
    ...
    return (
        "-- GENERATED by `python -m core.maker.classify --emit-sql` from core/maker/classify.py.\n"
