...
Usage:
    uv run python -m core.capture.ws_features --prefix KXWC --minutes 60   # capture during WC games
    uv run python -m core.capture.ws_features --btc --minutes 5   # smoke on always-active BTC
"""
...
from core.capture.ws_logger import CHANNELS, discover_markets
