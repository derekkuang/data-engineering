...
Usage:
    uv run python -m ml.live_exec_reconcile
"""
...
from ml.backtest import DROP_FEATURES, N_SPLITS, _breakeven_cost, _effective_quote, _summarise
from ml.data import TARGET_COL, feature_matrix, load_training_frame
from ml.model import logistic_pipeline, walk_forward_oof
...
def _backtest_universe() -> tuple[FloatArr, npt.NDArray[np.intp], FloatArr, FloatArr]:
    """Reproduce the backtest's out-of-fold universe (mirrors ml.backtest.main): the
