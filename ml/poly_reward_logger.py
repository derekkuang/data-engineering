...
Usage:
    uv run python -m ml.poly_reward_logger --minutes 180             # log for 3h
    uv run python -m ml.poly_reward_logger --minutes 600 --poll 3    # overnight, faster cadence
"""
...
from ml.polymarket_navigator import USDC, fetch_reward_markets, is_meanrev
