...
Usage:
    uv run python -m ml.alpha.favorite_longshot
"""
...
from ml.alpha.data import BENCHMARK_COL, TARGET_COL, load_training_frame
from ml.alpha.metrics import reliability_table
