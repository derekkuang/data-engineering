...
Usage:
    uv run python -m ml.lp_live --auth-check
    uv run python -m ml.lp_live --test-order              # auto-picks a market
    uv run python -m ml.lp_live --live --i-understand-live --minutes 15
"""
