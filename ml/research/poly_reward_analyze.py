...
Read data/poly_reward_book.csv + data/poly_reward_trades.csv (from ml.research.poly_reward_logger).
...
Usage:
    uv run python -m ml.research.poly_reward_analyze
    uv run python -m ml.research.poly_reward_analyze --horizons 30,60,120
"""
...
def main() -> int:
    ...
    if not books:
        print(f"No book data at {BOOK_LOG} — run ml.research.poly_reward_logger first.")
        return 1
