...
Usage:
    uv run python -m ml.research.pickoff_dynamics
    uv run python -m ml.research.pickoff_dynamics --days 21 --jump-thresh 3.0
"""
...
from ml.lp.classify import sport
from ml.lp.edge_verdict import day_block_ci
