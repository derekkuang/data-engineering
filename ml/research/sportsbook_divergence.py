...
Usage:
    uv run python -m ml.research.sportsbook_divergence --days 14
    uv run python -m ml.research.sportsbook_divergence --days 21 --edge 0.03
"""
...
from ml.lp.edge_verdict import day_block_ci  # the project's canonical day-block bootstrap CI
