...
answers the go/no-go on history for ~$0:
  ...
  * MARKET read  — the morning implied bucket probabilities (reuses
    strategies.weather_taker.calib_study).
...
Usage:
    uv run python -m strategies.weather_taker.h1_spike --days 45
    uv run python -m strategies.weather_taker.h1_spike --days 45 --when 09h
"""
...
from strategies.weather_taker.calib_study import (
    CITIES,
    DEFAULT_CITIES,
    _measured_day,
    build_samples,
