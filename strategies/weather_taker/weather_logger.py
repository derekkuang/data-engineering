...
Then strategies/weather_taker/weather_analyze.py (later) computes markout (esp. into
the close = convergence
...
Usage:
    uv run python -m strategies.weather_taker.weather_logger --minutes 600        # log a full day
    uv run python -m strategies.weather_taker.weather_logger --minutes 180 --poll 4
"""
