...
BTC-15m benchmark (strategies/btc_direction/altcoin_efficiency): fetch settled markets
...
Usage:
    uv run python -m strategies.weather_taker.calib_study --days 45
    uv run python -m strategies.weather_taker.calib_study --days 30 --cities NYC
"""
