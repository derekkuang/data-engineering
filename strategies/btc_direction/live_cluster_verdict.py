...
Usage:
    ...
    uv run python -m strategies.btc_direction.live_cluster_verdict
"""
...
from core.backtest.backtest import _per_window_pnl
...
from strategies.btc_direction.decision_minute_profit import (
    N_BOOT,
    RNG,
    _day_sums,
    _roi,
...
from strategies.btc_direction.settlement_lag import _load_at_k
