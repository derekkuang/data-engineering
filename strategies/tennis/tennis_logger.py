...
This is the read-only opposite of core/maker/lp_live — it places NO orders and uses NO auth. It
...
Usage:
    uv run python -m strategies.tennis.tennis_logger --minutes 180             # log for 3h
    uv run python -m strategies.tennis.tennis_logger --minutes 600 --poll 3  # overnight
"""
