...
This is the read-only opposite of core/maker/lp_live — it places NO orders, uses NO auth, needs NO
...
Usage:
    uv run python -m strategies.polymarket.poly_reward_logger --minutes 180          # log for 3h
    uv run python -m strategies.polymarket.poly_reward_logger --minutes 600 --poll 3  # overnight
"""
...
from strategies.polymarket.polymarket_navigator import USDC, fetch_reward_markets, is_meanrev
